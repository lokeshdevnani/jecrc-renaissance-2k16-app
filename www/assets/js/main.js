var renApp = angular.module('renApp', ['ionic']);
...
renApp.controller('mainController',['$scope','renService','$location','$rootScope','Page','$timeout',function($scope,renService,$location,$rootScope,Page,$timeout){
    $scope.Page = Page;
